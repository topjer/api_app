...
def test_add_url():
    ...
    response = client.post(
        "add_url",
        json={"url": "https://www.codecentric.de/ueber-uns/standorte/leipzig",
              "description": "Definitely apply here!"}
    )
    assert response.status_code == 200
    assert response.json() == {"message": "https://www.codecentric.de/ueber-uns/standorte/leipzig was added."}
    ...
    assert response_dict['long_url'] == "https://www.codecentric.de/ueber-uns/standorte/leipzig"
...
def test_redirect():
    _ = client.post(
        "add_url",
        json={"url": "https://www.manjaro.org"}
    )
